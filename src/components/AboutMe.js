const AboutMe = () => {
    return (
        <>
        <div className="flex flex-col max-w-fit bg-gray-50 py-8">
            <div className="flex flex-row px-16 py-4 text-subheader text-blue-500 font-semibold">About Me</div>
            <div className="px-24">
                ...
                <div className="flex flex-row py-2 px-4 text-lg text-blue-500 font-semibold drop-shadow-lg">
