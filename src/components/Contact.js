...
const Contact = () => {
    ...
    <div id="contact" className="flex flex-col justify-center space-y-8 py-12 bg-green-6 md:space-y-8 md:px-24 md:py-24 lg:space-y-10 lg:px-[15rem] lg:py-[14rem] xl:px-[28rem] xl:py-[10rem]">
        <div className="flex flex-row justify-center px-10 text-center text-4xl text-green-3 font-black md:text-[44px] md:drop-shadow-1">Let's get in touch!</div>
        <div className="flex flex-row justify-center px-16 text-center text-base text-green-2 md:text-[17px]">I'm on the lookout for new grad software engineering roles, so if you liked what you saw, feel free to send me a message below.</div>
