...
const Contact = () => {
    ...
    <div id="contact" className="flex flex-col justify-center space-y-4 py-12 bg-green-6 md:space-y-8 md:px-24 md:py-24">
        ...
        <div className="flex flex-row justify-center px-16 text-center text-sm text-green-2 md:text-[17px] lg:px-40 lg:text-[18px] lg:leading-6">I'm on the lookout for new grad software engineering roles, so if you liked what you saw, feel free to send me a message below.</div>
