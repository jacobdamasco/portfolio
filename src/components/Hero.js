    ...
    return (
        ...
        <div className="flex flex-row">
            <div className="flex flex-col basis-3/5 justify-center px-16 py-12">
                ...
                <div className="flex flex-row basis-3/4 my-8">
                    <div className="flex flex-col">
                        <button className="bg-blue-500 hover:bg-blue-600 text-white mr-4 py-3 px-9 rounded-xl text-xl">Resume</button>
                    </div>
            ...
            <div className="flex flex-col basis-2/5 px-2 py-4 justify-center">
                <img src={me} alt="Jacob Damasco at USC" className="shadow-2xl shadow-gray-700 rounded"/>
            </div>
        </div>
        </>
    );
